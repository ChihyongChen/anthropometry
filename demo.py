...
class HumanShapeAnalysisDemo(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.viewer3D = maya_widget.MayaviQWidget(container)
    ...
    #         mode = maya_widget.myAction(i, self.mode[i], self)
    ...
    #         slider = maya_widget.IndexedQSlider(i, QtCore.Qt.Horizontal, self)
