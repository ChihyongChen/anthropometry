function [linelength]=computeLengthOfTriangle(keyz,triangle)
...
for currentindex = 1:3
    ...
    if keyz == triangle(currentindex,3)
        ...
        if zz>0 & zz<1
            ...
            %line([xx1,xx],[yy1,yy],[keyz,keyz],'Color','red','LineStyle','--');
            return;
    ...
    if zz>0 & zz<1
        ...
        elseif intersection == 1
            ...
            %line([xx1,xx2],[yy1,yy2],[keyz,keyz],'Color','red','LineStyle','--');
